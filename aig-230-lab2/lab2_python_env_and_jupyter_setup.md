# Lab 2 – Python Virtual Environment and Jupyter Setup (Windows + Git Bash + VS Code)
...
```bash
cd "~/Documents/Seneca Polytechnic/AIG230 - NLP/labs/aig-230-lab02"
```
...
## Part E. Install Required Libraries

``` bash
pip install pandas numpy nltk
```

## Part F. Register the Environment as a Jupyter Kernel
...
## Part G. Open the Project in VS Code
...
```
Documents/Seneca Polytechnic/AIG230 - NLP/labs/aig-230-lab02
```

---

## Part H. Select the Python Interpreter in VS Code (Required)
...
## Part I. Select the Kernel in the Notebook
...
## Part J. Final Verification (Required)
